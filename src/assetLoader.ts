 ...
 */
export function sendWallTilesToWebview(postMessage: PostMessage, wallTiles: LoadedWallTiles): void {
  postMessage({
 ...
 */
export function sendAssetsToWebview(postMessage: PostMessage, assets: LoadedAssets): void {
  if (!assets) {
