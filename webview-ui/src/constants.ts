...
export const TOOL_OVERLAY_VERTICAL_OFFSET = 48;
export const PULSE_ANIMATION_DURATION_SEC = 1.5;
export const PERMISSION_GLOW_PERIOD_MS = 700;
export const PERMISSION_GLOW_BLUR_MIN = 3;
export const PERMISSION_GLOW_BLUR_MAX = 10;
export const PERMISSION_GLOW_COLOR = 'rgba(255, 160, 0, 0.85)';
