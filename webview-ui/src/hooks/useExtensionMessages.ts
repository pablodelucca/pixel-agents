...
export function useExtensionMessages(
  ...
  useEffect(() => {
    ...
    const handler = (e: MessageEvent) => {
      ...
      if (msg.type === 'layoutLoaded') {
        ...
        if (msg.claudeAvailable !== undefined) {
          setClaudeAvailable(msg.claudeAvailable as boolean)
        }
  ...
  return { agents, selectedAgent, agentTools, agentStatuses, subagentTools, subagentCharacters, layoutReady, loadedAssets, workspaceFolders, claudeAvailable }
}
