...
export class OfficeState {
  ...
  addAgent(id: number, preferredPalette?: number, preferredHueShift?: number, preferredSeatId?: string, skipSpawnEffect?: boolean, folderName?: string, personaTagline?: string): void {
    ...
    if (personaTagline) {
      ch.personaTagline = personaTagline
    }
    if (!skipSpawnEffect) {
