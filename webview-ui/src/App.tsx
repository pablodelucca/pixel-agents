...
function App() {
  ...
  const { agents, selectedAgent, agentTools, agentStatuses, subagentTools, subagentCharacters, layoutReady, loadedAssets, agentType } = useExtensionMessages(getOfficeState, editor.setLastSavedLayout, isEditDirty)
